...
public class Principal {
    ...
    private void buscarEpisodiosDepoisDeUmaData() {
        ...
        if(serieBusca.isPresent()){
            ...
            System.out.print("A partir de qual ano de lançamento: ");
            var anoLancamento = sc.nextInt();
            sc.nextLine();
            List<Episodio> episodiosAno = serieRepository.findByAno(serie, anoLancamento);
            episodiosAno.forEach(e -> System.out.println("Data de Lançamento: " + e.getDataLancamento() +
                    " Nome do Episódio: " + e.getTitulo() + " Temporada: " + e.getTemporada()));
        }
    }
...
//      List<Serie> filtroSeries = serieRepository.findByTotalTemporadasLessThanEqualAndAvaliacaoGreaterThanEqual(totalTemporadas,avaliacao);
    ...
    private void buscarEpisodioPorTrecho() {
        ...
        List<Episodio> episodiosEncontrados = serieRepository.episodiorPorTrecho(trechoEpisodio);
        System.out.println("*** Episodio encontrado ***");
        episodiosEncontrados.forEach(e -> System.out.println("Série: " + e.getSeries().getTitulo() + " Temporada: " +
                e.getTitulo() + " - Episódio " + e.getNumeroEpisodio() + " - " + e.getTitulo()));
    }
    ...
    private void topEpisodiosPorSerie() {
        ...
        if(serieBusca.isPresent()){
            ...
            topEpisodios.forEach(e -> System.out.println("Avaliação do Episódio: " + e.getAvaliacao() +
                    " Série: " + e.getSeries().getTitulo() + " Temporada: " +
                    e.getTitulo() + " - Episódio " + e.getNumeroEpisodio() + " - " + e.getTitulo()));
        }
    }
}
